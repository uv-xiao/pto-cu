...
def test_private_runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status_is_backend_owned(
    tmp_path,
):
    output = _compile_and_run(
        tmp_path,
        ...
        int main() {
            ...
            PtoCudaRuntimeFusionRequest request = {};
            request.version = PTO_CUDA_RUNTIME_FUSION_REQUEST_VERSION;
            request.callable_id = 57;
            request.invocation_id = 10001U;
            request.chip_storage_task_args = &chip_storage;
            request.chip_storage_task_args_size = sizeof(chip_storage);
            request.persistent_graph_descriptor = reinterpret_cast<const void *>(0x20);
            request.comm_descriptor = &descriptor;
            ...
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_OWNER_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                invocation_id = request.invocation_id + 1U;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_INVOCATION_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                result_transport_status = nullptr;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_RESULT_TRANSPORT_SCAFFOLD_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                shared_token += 1U;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_DESCRIPTOR_TOKEN_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                world_size += 1U;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_RANK_DEVICE_WORLD_SIZE_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                status_sink = nullptr;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_STATUS_SINK_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                result_sink = nullptr;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_RESULT_SINK_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                transport_sink = nullptr;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_TRANSPORT_SINK_HANDLE_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                completion_sink = nullptr;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_COMPLETION_SINK_HANDLE_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.
                completion_handle = nullptr;
            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_COMPLETION_SINK_HANDLE_MISMATCH;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_PUBLIC_API_SOURCED_STATE;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_PROVENANCE_SOURCED_STATE;
            expect_failed();

            coordinator.runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_completion_scaffold_status.status =
                PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_COMPLETION_STATUS_FABRICATED_PASS_EVIDENCE;
            expect_failed();
    ...
    assert (
        "driver_backend_combine_payload_transfer_completion_handoff_result_"
        "transport_completion_map_unsupported_boundary"
    ) in output
    assert "driver_backend_combine_payload_scaffold_status" in output
    assert (
        "private UCCL-EP runtime dispatch driver backend combine payload "
