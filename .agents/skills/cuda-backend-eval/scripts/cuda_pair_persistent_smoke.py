...
from cuda_pair_persistent_smoke_impl.contracts import (  # noqa: E402
...
def _expected_completed_count(config: PairedPersistentSmokeConfig) -> int:
    ...
    return {
        ...
        "graph_descriptor_layered_cross": 9,
        "graph_descriptor_multi_fanin": 4,
        "graph_descriptor_parallel_chains": 9,
        "graph_descriptor_wide_fanout": 7,
...
def _expected_dispatch(config: PairedPersistentSmokeConfig) -> str | None:
    ...
    return {
        ...
        "graph_descriptor_layered_cross": "1,2,11,1,2,1,6,1,1",
        "graph_descriptor_multi_fanin": "1,2,11,6",
        ...
        "graph_descriptor_parallel_chains": "1,2,1,2,1,1,2,1,1",
        "graph_descriptor_wide_fanout": "1,1,2,1,1,2,1",
...
def _expected_graph_descriptor(config: PairedPersistentSmokeConfig) -> tuple[str, str] | None:
    ...
    return {
        ...
        "graph_descriptor_layered_cross": ("0,0,0,2,3,1,2,3,2", "3,3,4,4,5,4,6,7,6,7,7,8,8"),
        "graph_descriptor_multi_fanin": ("0,0,0,3", "3,3,3"),
        ...
        "graph_descriptor_parallel_chains": ("0,0,0,0,2,2,2,2,2", "4,4,5,5,6,7,6,7,8,8"),
        "graph_descriptor_wide_fanout": ("0,1,1,1,2,2,2", "1,2,3,4,4,5,5,6,6"),
