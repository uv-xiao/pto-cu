...
| QK norm, RoPE, attention | FlashInfer decode/QK-RoPE, SGLang fused QKNorm-RoPE | PTO has shape-field QK RMSNorm and RoPE formula source; model RoPE table binding and decode attention remain open. |
