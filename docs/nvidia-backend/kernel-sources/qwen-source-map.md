...
| QK norm, RoPE, attention | FlashInfer decode/QK-RoPE, SGLang fused QKNorm-RoPE | PTO has shape-field QK RMSNorm/RoPE formula source and descriptor-level RoPE table slots; live RoPE pointer binding and decode attention remain open. |
