...
The selected map should define allocator owner, host-control record policy,
device-visible descriptor buffer policy, dispatch descriptor identity, combine
descriptor identity, shared-token requirement, rank/device compatibility, and
