...
small: `rows=2, vocab=8, max_k=5, min_p=0.5`.
The probabilities already sum to one. Candidates whose probability is at least
...
- validation flags for values, indices, and selected counts;
- explicit non-claims.
...
- CPU golden values:
  `[[0.3, 0.2, 0.15, 0.0, 0.0], [0.25, 0.25, 0.15, 0.0, 0.0]]`;
- CPU golden indices: `[[1, 3, 5, -1, -1], [0, 2, 6, -1, -1]]`;
- CPU golden selected counts: `[3, 3]`;
- GPU result values:
  `[[0.3, 0.2, 0.15, 0.0, 0.0], [0.25, 0.25, 0.15, 0.0, 0.0]]`;
- GPU result indices: `[[1, 3, 5, -1, -1], [0, 2, 6, -1, -1]]`;
- GPU result selected counts: `[3, 3]`;
...
- This is a tiny static-shape min-p correctness gate, not broad vocabulary
  coverage.
