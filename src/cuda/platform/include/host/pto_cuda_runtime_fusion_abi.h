...
enum PtoCudaUcclEpRuntimeDispatchDriverBackendCombinePayloadTransferCompletionHandoffResultTransportStatus
    : uint32_t {
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_PENDING = 1,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_UNIMPLEMENTED = 2,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_STATUS_SINK_UNBOUND = 3,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_RESULT_SINK_UNBOUND = 4,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_SINK_UNBOUND = 5,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_HANDLE_UNBOUND = 6,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_UNSUPPORTED_BOUNDARY = 7,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_OWNER_MISMATCH = 8,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_INVOCATION_MISMATCH = 9,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_HANDOFF_RESULT_SCAFFOLD_MISMATCH = 10,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_DESCRIPTOR_TOKEN_MISMATCH = 11,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_RANK_DEVICE_WORLD_SIZE_MISMATCH = 12,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_STATUS_SINK_MISMATCH = 13,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_RESULT_SINK_MISMATCH = 14,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_SINK_MISMATCH = 15,
    PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_HANDLE_MISMATCH = 16,
...
struct PtoCudaUcclEpRuntimeDispatchDriverBackendCombinePayloadTransferCompletionHandoffResultTransportScaffoldStatus {
    uint32_t version;
    uint64_t invocation_id;
    const void *transport_owner;
    const PtoCudaUcclEpRuntimeDispatchDriverBackendRequestScaffoldStatus *backend_request_status;
    const PtoCudaUcclEpRuntimeDispatchDriverBackendDispatchRequestScaffoldStatus *dispatch_request_status;
    const PtoCudaUcclEpRuntimeDispatchDriverBackendCombineRequestScaffoldStatus *combine_request_status;
    const PtoCudaUcclEpRuntimeDispatchDriverBackendCombinePayloadScaffoldStatus *combine_payload_status;
    ...
    PtoCudaRuntimeFusionResult *status_sink;
    PtoCudaRuntimeFusionResult *result_sink;
    PtoCudaRuntimeFusionResult *transport_sink;
...
pto_cuda_uccl_ep_runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_status_name(
    ...
    switch (status) {
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_PENDING:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_pending";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_UNIMPLEMENTED:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_unimplemented";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_STATUS_SINK_UNBOUND:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_status_sink_unbound";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_RESULT_SINK_UNBOUND:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_result_sink_unbound";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_SINK_UNBOUND:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_sink_unbound";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_HANDLE_UNBOUND:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_handle_unbound";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_UNSUPPORTED_BOUNDARY:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_map_unsupported_boundary";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_OWNER_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_owner_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_INVOCATION_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_invocation_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_HANDOFF_RESULT_SCAFFOLD_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_handoff_result_scaffold_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_DESCRIPTOR_TOKEN_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_descriptor_token_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_RANK_DEVICE_WORLD_SIZE_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_rank_device_world_size_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_STATUS_SINK_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_status_sink_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_RESULT_SINK_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_result_sink_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_SINK_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_sink_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_TRANSPORT_HANDLE_MISMATCH:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_handle_mismatch";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_PUBLIC_API_SOURCED_STATE:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_public_api_sourced_state";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_PROVENANCE_SOURCED_STATE:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_provenance_sourced_state";
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_FABRICATED_PASS_EVIDENCE:
            return "driver_backend_combine_payload_transfer_completion_handoff_result_transport_fabricated_pass_evidence";
        default:
            return "unknown_driver_backend_combine_payload_transfer_completion_handoff_result_transport_status";
    }
}
...
inline int pto_cuda_runtime_fusion_prepare_private_coordinator(
    ...
    *coordinator = {};
    ...
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_scaffold_status.failure_fields =
        PTO_CUDA_RUNTIME_FUSION_FAILURE_UNSUPPORTED_BOUNDARY;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.version =
    ...
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.invocation_id =
        request->invocation_id;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.transport_owner =
        coordinator;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.backend_request_status =
        &coordinator->runtime_dispatch_driver_backend_request_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.dispatch_request_status =
        &coordinator->runtime_dispatch_driver_backend_dispatch_request_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.combine_request_status =
        &coordinator->runtime_dispatch_driver_backend_combine_request_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.combine_payload_status =
        &coordinator->runtime_dispatch_driver_backend_combine_payload_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.transfer_status =
        &coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.completion_status =
        &coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.handoff_status =
        &coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.handoff_result_status =
        &coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.runtime_path =
        &coordinator->descriptor_allocation.runtime_path;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.status_sink =
        output_sink;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.result_sink =
        output_sink;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.transport_sink =
        output_sink;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.transport_handle =
        &coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_scaffold_status;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.combine_payload_descriptor =
        coordinator->descriptor_allocation.runtime_path.combine_descriptor;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.shared_token =
        coordinator->descriptor_allocation.combine_descriptor.shared_token;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.rank =
        coordinator->descriptor_allocation.combine_descriptor.rank;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.device_id =
        coordinator->descriptor_allocation.combine_descriptor.device_id;
    coordinator->runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status.world_size =
        coordinator->descriptor_allocation.combine_descriptor.world_size;
...
pto_cuda_runtime_fusion_validate_runtime_dispatch_driver_backend_combine_payload_transfer_completion_handoff_result_transport_scaffold_status(
    ...
    if (transport_status->version !=
        PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_SCAFFOLD_STATUS_VERSION) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_OWNER_MISMATCH;
    }
    if (transport_status->invocation_id != request->invocation_id) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_INVOCATION_MISMATCH;
    }
    if (transport_status->transport_owner != coordinator) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_OWNER_MISMATCH;
    }
    if (transport_status->backend_request_status !=
        &coordinator->runtime_dispatch_driver_backend_request_scaffold_status) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_REQUEST_SCAFFOLD;
    }
    if (transport_status->dispatch_request_status !=
        &coordinator->runtime_dispatch_driver_backend_dispatch_request_scaffold_status) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_DISPATCH_REQUEST_SCAFFOLD;
    }
    if (transport_status->combine_request_status !=
        &coordinator->runtime_dispatch_driver_backend_combine_request_scaffold_status) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_REQUEST_SCAFFOLD;
    }
    if (transport_status->combine_payload_status != combine_payload_status ||
        transport_status->transfer_status != transfer_status ||
        transport_status->completion_status != completion_status ||
        transport_status->handoff_status != handoff_status ||
        transport_status->handoff_result_status != handoff_result_status) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD;
    }
    if (transport_status->runtime_path != runtime_path) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_RUNTIME_PATH_MISMATCH;
    }
    if (transport_status->status_sink == nullptr ||
        transport_status->status_sink != request->output_sink) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_STATUS_SINK_MISMATCH;
    }
    if (transport_status->result_sink == nullptr ||
        transport_status->result_sink != request->output_sink) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_STATUS_SINK_MISMATCH;
    }
    if (transport_status->transport_sink == nullptr ||
        transport_status->transport_sink != request->output_sink) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_STATUS_SINK_MISMATCH;
    }
    if (transport_status->transport_handle == nullptr ||
        transport_status->transport_handle != handoff_result_status) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_DESCRIPTOR_TOKEN_MISMATCH;
    }
    if (combine_descriptor == nullptr ||
        transport_status->combine_payload_descriptor != combine_descriptor ||
        transport_status->combine_payload_descriptor !=
            combine_payload_status->combine_payload_descriptor ||
        transport_status->combine_payload_descriptor != transfer_status->combine_payload_descriptor ||
        transport_status->combine_payload_descriptor != completion_status->combine_payload_descriptor ||
        transport_status->combine_payload_descriptor != handoff_status->combine_payload_descriptor ||
        transport_status->combine_payload_descriptor !=
            handoff_result_status->combine_payload_descriptor ||
        transport_status->shared_token == 0U ||
        transport_status->shared_token != combine_descriptor->shared_token ||
        transport_status->shared_token != combine_payload_status->shared_token ||
        transport_status->shared_token != transfer_status->shared_token ||
        transport_status->shared_token != completion_status->shared_token ||
        transport_status->shared_token != handoff_status->shared_token ||
        transport_status->shared_token != handoff_result_status->shared_token) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_DESCRIPTOR_TOKEN_MISMATCH;
    }
    if (request->comm_descriptor != nullptr &&
        (transport_status->rank != request->comm_descriptor->rank ||
         transport_status->device_id != request->comm_descriptor->device_id ||
         transport_status->world_size != request->comm_descriptor->world_size ||
         transport_status->rank != combine_payload_status->rank ||
         transport_status->device_id != combine_payload_status->device_id ||
         transport_status->world_size != combine_payload_status->world_size ||
         transport_status->rank != transfer_status->rank ||
         transport_status->device_id != transfer_status->device_id ||
         transport_status->world_size != transfer_status->world_size ||
         transport_status->rank != completion_status->rank ||
         transport_status->device_id != completion_status->device_id ||
         transport_status->world_size != completion_status->world_size ||
         transport_status->rank != handoff_status->rank ||
         transport_status->device_id != handoff_status->device_id ||
         transport_status->world_size != handoff_status->world_size ||
         transport_status->rank != handoff_result_status->rank ||
         transport_status->device_id != handoff_result_status->device_id ||
         transport_status->world_size != handoff_result_status->world_size)) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_RANK_DEVICE_MISMATCH;
    }

    const uint32_t propagated_transport_failures =
        transport_status->failure_fields &
        (PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_OWNER_MISMATCH |
         PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_INVOCATION_MISMATCH |
         PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_RUNTIME_PATH_MISMATCH |
         PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_DESCRIPTOR_TOKEN_MISMATCH |
         ...
         PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_REQUEST_SCAFFOLD |
         PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD);
    if (propagated_transport_failures != 0U) {
        failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                    propagated_transport_failures;
    }

    switch (transport_status->status) {
        case PTO_CUDA_UCCL_EP_RUNTIME_DISPATCH_DRIVER_BACKEND_COMBINE_PAYLOAD_TRANSFER_COMPLETION_HANDOFF_RESULT_TRANSPORT_STATUS_OWNER_MISMATCH:
            failures |= PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_BACKEND_COMBINE_PAYLOAD_SCAFFOLD |
                        PTO_CUDA_RUNTIME_FUSION_FAILURE_DRIVER_OWNER_MISMATCH;
            break;
