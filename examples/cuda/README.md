...
tensor count, binding groups, total size, and the remaining tensor-open and
CUDA weight-binding gaps.
...
binding groups reviewable before any model tensors are opened or copied.
